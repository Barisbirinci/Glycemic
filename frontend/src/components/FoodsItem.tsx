...
import { basketAdd, fncDateConvert } from '../Util';
...
export default function FoodsItem( props: itemType ) {
    ...
    function fncGotoAdd(arg0: number): void {
    ...
    return (
        ...
        <Card fluid  >
            ...
            <Card.Description>
            <Card.Meta color="blue" >{ props.item.createdBy === null ? 'user@mail.com' :  props.item.createdBy }</Card.Meta>
