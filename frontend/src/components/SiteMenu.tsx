...
import { Menu, Button, Modal, Form, Icon, Segment, Label, DropdownMenu, DropdownItem, Input, Card, Feed } from 'semantic-ui-react'
...
export default function SiteMenu() {
  ...
  const [basket, setbasket] = useState<ResultFoods>()
  ...
  //shopping basket
  const basketadd =(cardAdd:ResultFoods)=>{
