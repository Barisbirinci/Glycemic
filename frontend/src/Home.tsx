import React, { SyntheticEvent, useEffect, useState,createContext } from 'react';
...
import { Card, Dropdown, DropdownProps, Form, Grid, Icon, Input, Label, Pagination, PaginationProps, Segment, Select } from 'semantic-ui-react';
...
<Grid>
  ...
  <Grid.Column width='14'>
    ...
    <Grid.Column width='2'>
      <Label  color='red' style={{ display:'red', justifyContent:'center', fontSize:16 }} >
        {foodsArr.length}
      </Label>
